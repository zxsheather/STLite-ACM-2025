...
class map {
 ...
 public:
  ...
  //     printNodeAndChildren(root_, 0);
  //   } else {
  //     std::cout << "Empty tree (root_ = nullptr)\n";
  //   }
  //   std::cout << "=================================\n\n";
  // }

  // // 添加到map类的private部分
  // void printNodeAndChildren(Node *node, int level) {
  //   // 树形缩进
  ...
  //                 << "}, ";
  //     } catch (...) {
  //       std::cout << "[ERROR: 数据访问失败], ";
  //     }

  //     // 打印高度和平衡因子
  //     std::cout << "height=" << node->height << ", ";
  //     int bf = height(node->left) - height(node->right);
  //     std::cout << "balance=" << bf << std::endl;
  ...
  //                   << "}" << std::endl;
  //       } catch (...) {
  //         std::cout << "@" << node->parent << " [ERROR: 父节点数据访问失败]"
  //                   << std::endl;
  //       }
  //     } else {
  ...
  //       std::cout << "@" << node->left << " ";
  //       try {
  //         std::cout << "{" << node->left->data.first << "}" << std::endl;
  //         // 递归处理左子树
  //         printNodeAndChildren(node->left, level + 1);
  //       } catch (...) {
  //         std::cout << "[ERROR: 左子节点数据访问失败]" << std::endl;
  //       }
  //     } else {
  //       std::cout << "nullptr" << std::endl;
  //     }
  ...
  //       std::cout << "@" << node->right << " ";
  //       try {
  //         std::cout << "{" << node->right->data.first << "}" << std::endl;
  //         // 递归处理右子树
  //         printNodeAndChildren(node->right, level + 1);
  //       } catch (...) {
  //         std::cout << "[ERROR: 右子节点数据访问失败]" << std::endl;
  //       }
  //     } else {
  //       std::cout << "nullptr" << std::endl;
  //     }
  //   } catch (...) {
  //     std::cout << indent << "[ERROR: 节点 @" << node << " 无法访问]"
  //               << std::endl;
  //   }
  // }

  // void printNodeAndChildren(iterator pos, int level){
  //   printNodeAndChildren(pos.node, level);
  // }
  ...
  //   bool valid = validateNode(root_, nullptr, actualCount);

  //   if (actualCount != size_) {
  //     std::cout << "错误: 实际节点数 (" << actualCount << ") 与记录的size_ ("
  //               << size_ << ") 不符!\n";
  //     valid = false;
  //   }
  ...
  // bool validateNode(Node *node, Node *expectedParent, size_t &count) {
  //   if (!node) return true;
  ...
  //     std::cout << "错误: 节点 " << node->data.first << " 的父指针 ("
  //               << node->parent << ") 与预期 (" << expectedParent
  //               << ") 不符!\n";
  //     valid = false;
  //   }
  ...
  //   // 验证左子节点的父指针
  //   if (node->left && node->left->parent != node) {
  //     std::cout << "错误: 节点 " << node->data.first << " 的左子节点 ("
  //               << node->left->data.first << ") 的父指针不指向该节点!\n";
  //     valid = false;
  //   }

  //   // 验证右子节点的父指针
  //   if (node->right && node->right->parent != node) {
  //     std::cout << "错误: 节点 " << node->data.first << " 的右子节点 ("
  //               << node->right->data.first << ") 的父指针不指向该节点!\n";
  //     valid = false;
  //   }

  //   // 递归验证子树
  //   valid &= validateNode(node->left, node, count);
  //   valid &= validateNode(node->right, node, count);
